...
func (AddUEHeaderEnrichmentResult_Result) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_envoy_controller_c05124a05775ccb1, []int{2, 0}
}
...
func (DeactivateUEHeaderEnrichmentResult_Result) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_envoy_controller_c05124a05775ccb1, []int{4, 0}
}
...
func (*Header) Descriptor() ([]byte, []int) {
	return fileDescriptor_envoy_controller_c05124a05775ccb1, []int{0}
}
...
func (*AddUEHeaderEnrichmentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_envoy_controller_c05124a05775ccb1, []int{1}
}
...
func (dst *AddUEHeaderEnrichmentRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddUEHeaderEnrichmentRequest.Merge(dst, src)
}
...
func (*AddUEHeaderEnrichmentResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_envoy_controller_c05124a05775ccb1, []int{2}
}
...
func (dst *AddUEHeaderEnrichmentResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddUEHeaderEnrichmentResult.Merge(dst, src)
}
...
func (*DeactivateUEHeaderEnrichmentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_envoy_controller_c05124a05775ccb1, []int{3}
}
...
func (dst *DeactivateUEHeaderEnrichmentRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeactivateUEHeaderEnrichmentRequest.Merge(dst, src)
}
...
func (*DeactivateUEHeaderEnrichmentResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_envoy_controller_c05124a05775ccb1, []int{4}
}
...
func (dst *DeactivateUEHeaderEnrichmentResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeactivateUEHeaderEnrichmentResult.Merge(dst, src)
}
...
func NewEnvoyControllerClient(cc *grpc.ClientConn) EnvoyControllerClient {
...
func init() {
	proto.RegisterFile("feg/protos/envoy_controller.proto", fileDescriptor_envoy_controller_c05124a05775ccb1)
}

var fileDescriptor_envoy_controller_c05124a05775ccb1 = []byte{
