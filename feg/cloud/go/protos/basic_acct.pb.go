...
func (*AcctSession) Descriptor() ([]byte, []int) {
	return fileDescriptor_basic_acct_9093a8206cd52631, []int{0}
}
...
func (dst *AcctSession) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AcctSession.Merge(dst, src)
}
...
func (*AcctSession) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _AcctSession_OneofMarshaler, _AcctSession_OneofUnmarshaler, _AcctSession_OneofSizer, []interface{}{
...
func _AcctSession_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*AcctSession)
	// user
	switch x := m.User.(type) {
	case *AcctSession_IMSI:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.IMSI)
	case *AcctSession_CertificateSerialNumber:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		b.EncodeRawBytes(x.CertificateSerialNumber)
	case *AcctSession_HardwareAddr:
		b.EncodeVarint(3<<3 | proto.WireBytes)
		b.EncodeRawBytes(x.HardwareAddr)
	case *AcctSession_Name:
		b.EncodeVarint(4<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.Name)
	case nil:
	default:
		return fmt.Errorf("AcctSession.User has unexpected type %T", x)
	}
	return nil
}

func _AcctSession_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*AcctSession)
	switch tag {
	case 1: // user.IMSI
		...
		m.User = &AcctSession_IMSI{x}
		return true, err
	case 2: // user.certificate_serial_number
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeRawBytes(true)
		m.User = &AcctSession_CertificateSerialNumber{x}
		return true, err
	case 3: // user.hardware_addr
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeRawBytes(true)
		m.User = &AcctSession_HardwareAddr{x}
		return true, err
	case 4: // user.name
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
...
func _AcctSession_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*AcctSession)
	// user
	switch x := m.User.(type) {
	case *AcctSession_IMSI:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.IMSI)))
		n += len(x.IMSI)
	case *AcctSession_CertificateSerialNumber:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.CertificateSerialNumber)))
		n += len(x.CertificateSerialNumber)
	case *AcctSession_HardwareAddr:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.HardwareAddr)))
		n += len(x.HardwareAddr)
	case *AcctSession_Name:
		n += 1 // tag and wire
...
func (*AcctSessionResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_basic_acct_9093a8206cd52631, []int{1}
}
...
func (dst *AcctSessionResp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AcctSessionResp.Merge(dst, src)
}
...
func (*AcctSessionResp_ReportLimits) Descriptor() ([]byte, []int) {
	return fileDescriptor_basic_acct_9093a8206cd52631, []int{1, 0}
}
...
func (dst *AcctSessionResp_ReportLimits) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AcctSessionResp_ReportLimits.Merge(dst, src)
}
...
func (*AcctUpdateReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_basic_acct_9093a8206cd52631, []int{2}
}
...
func (dst *AcctUpdateReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AcctUpdateReq.Merge(dst, src)
}
...
func (*AcctStopResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_basic_acct_9093a8206cd52631, []int{3}
}
...
func (dst *AcctStopResp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AcctStopResp.Merge(dst, src)
}
...
func (*AcctQoS) Descriptor() ([]byte, []int) {
	return fileDescriptor_basic_acct_9093a8206cd52631, []int{4}
}
...
func (dst *AcctQoS) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AcctQoS.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("feg/protos/basic_acct.proto", fileDescriptor_basic_acct_9093a8206cd52631)
}

var fileDescriptor_basic_acct_9093a8206cd52631 = []byte{
