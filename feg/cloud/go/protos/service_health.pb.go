...
func (*DisableMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_health_c3bc39a9e185b776, []int{0}
}
...
func init() {
	proto.RegisterFile("feg/protos/service_health.proto", fileDescriptor_service_health_c3bc39a9e185b776)
}

var fileDescriptor_service_health_c3bc39a9e185b776 = []byte{
